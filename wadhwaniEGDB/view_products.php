...
if (isset($_GET['np'])) { // Already been determined.
    ...
    $query = "select Count(*) from products as p, manufacturer as m, product_subtype as ps where p.idManufacturer = m.idManufacturer AND p.idProduct_Subtype = ps.idProduct_Subtype";
...
$link1 = "{$_SERVER['PHP_SELF']}?sort=p_d";
...
if (isset($_GET['sort'])) {
    ...
    switch ($_GET['sort']) {
        ...
        case 'p_d':
            ...
            $link1 = "{$_SERVER['PHP_SELF']}?sort=p_a";
            break;
        case 'rd_a':
...
// Make the query.
$query = "select p.idProducts, p.p_name, p.p_releasedate, p.p_price, m.m_name, ps.s_name from products as p, manufacturer as m, product_subtype as ps where p.idManufacturer = m.idManufacturer AND p.idProduct_Subtype = ps.idProduct_Subtype ORDER BY $order_by LIMIT $start, $display";
