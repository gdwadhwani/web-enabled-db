...
if ($num_pages > 1) {
    ...
    if ($current_page != 1) {
        echo '<a href="product_manufacturer.php?s=0&np=' . $num_pages . '&sort=' . $sort . '&id=' .$id .'">First</a> ';
        echo '<a href="product_manufacturer.php?s=' . ($start - $display) . '&np=' . $num_pages . '&sort=' . $sort .'&id=' .$id .'">Previous</a> ';
    }

    // Make all the numbered pages.
    for ($i = 1; $i <= $num_pages; $i++) {
        if ($i != $current_page) {
            echo '<a href="product_manufacturer.php?s=' . (($display * ($i - 1))) . '&np=' . $num_pages . '&sort=' . $sort .'&id=' .$id .'">' . $i . '</a> ';
        } else {
            echo $i . ' ';
        }
    }
    ...
    if ($current_page != $num_pages) {
        echo '<a href="product_manufacturer.php?s=' . ($start + $display) . '&np=' . $num_pages . '&sort=' . $sort .'&id=' .$id .'">Next</a> ';
        echo '<a href="product_manufacturer.php?s=' . (($num_pages-1) * $display) . '&np=' . $num_pages . '&sort=' . $sort .'&id=' .$id .'">Last</a>';
    }
